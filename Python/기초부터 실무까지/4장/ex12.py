...
# 다른 조건은 전혀 검사 조차도 하지 않는다.(단축 계산)
# and 논리 연산자는 모든 조건이 참이어야지만 참을 반환한다.(중요)
if (age >= 15) and (height >= 160) and (name == "CoderPYE"):
...
if (age >= 15) or (height >= 165) or (name == "CoderPUE"):
    print(name + "님은 놀이기구를 탈 수 있습니다.")
else:
    print(name + "님은 놀이기구를 탈 수 없습니다.")
...
print("------------------------------------------")
# not 논리 부정 연산자 실습
# not 논리 부정 연산자는 조건이 참이면 전체 조건식의 결과를 반대로 거짓으로 만들고
